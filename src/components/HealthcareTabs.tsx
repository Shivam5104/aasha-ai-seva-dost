  ...
  return (
    <div className="w-full">
      <Tabs defaultValue="symptom-checker" className="w-full">
        <TabsList className="grid w-full grid-cols-2 xs:grid-cols-4 lg:grid-cols-7 mb-4 sm:mb-8 h-auto p-1 gap-2 sm:gap-4">
          <TabsTrigger value="symptom-checker" className="flex flex-col items-center gap-1 p-2 sm:p-3 text-xs">
            <Heart className="w-4 h-4" />
            <span className="hidden sm:inline">{translations.symptom_checker}</span>
            <span className="sm:hidden">{translations.symptoms}</span>
          </TabsTrigger>
          <TabsTrigger value="medicine-delivery" className="flex flex-col items-center gap-1 p-2 sm:p-3 text-xs">
          ...
          <TabsTrigger value="doctor-schedule" className="flex flex-col items-center gap-1 p-2 sm:p-3 text-xs">
          ...
          <TabsTrigger value="medication-alarm" className="flex flex-col items-center gap-1 p-2 sm:p-3 text-xs">
            <Clock className="w-4 h-4" />
            <span className="hidden sm:inline">{translations.medication_alarms}</span>
            <span className="sm:hidden">{translations.alarms}</span>
          </TabsTrigger>
          <TabsTrigger value="medical-history" className="flex flex-col items-center gap-1 p-2 sm:p-3 text-xs">
            <FileText className="w-4 h-4" />
            <span className="hidden sm:inline">{translations.medical_history}</span>
            <span className="sm:hidden">{translations.history}</span>
          </TabsTrigger>
          <TabsTrigger value="voice-support" className="flex flex-col items-center gap-1 p-2 sm:p-3 text-xs">
            <Phone className="w-4 h-4" />
            <span className="hidden sm:inline">{translations.voice_support}</span>
            <span className="sm:hidden">{translations.voice}</span>
          </TabsTrigger>
          <TabsTrigger value="ai-assistant" className="flex flex-col items-center gap-1 p-2 sm:p-3 text-xs">
        ...
        <div className="rounded-lg shadow-inner bg-white dark:bg-gray-800 px-2 py-2 sm:p-4 space-y-4 sm:space-y-6">
